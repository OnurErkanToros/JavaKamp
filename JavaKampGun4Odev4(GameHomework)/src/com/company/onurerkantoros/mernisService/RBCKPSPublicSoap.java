...
public class RBCKPSPublicSoap
{
    ...
    public RBCKPSPublicSoap(){}

    public RBCKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public RBCKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        RBCExtendedSoapSerializationEnvelope envelope= new RBCExtendedSoapSerializationEnvelope(RBCExtendedSoapSerializationEnvelope.VER11);
