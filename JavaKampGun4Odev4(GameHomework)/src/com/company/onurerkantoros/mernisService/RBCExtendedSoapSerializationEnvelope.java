...
public class RBCExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(RBCDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new RBCStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static RBCDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static RBCDateTimeConverter dateTimeConverter = new RBCStandardDateTimeConverter();

    public RBCExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public RBCExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new RBCMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=RBCHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,RBCExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=RBCHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
