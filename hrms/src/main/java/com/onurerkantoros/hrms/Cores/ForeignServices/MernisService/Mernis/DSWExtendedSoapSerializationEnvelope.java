...
public class DSWExtendedSoapSerializationEnvelope extends com.easywsdl.exksoap2.serialization.ExSoapSerializationEnvelope {
    ...
    public static void setDateTimeConverter(DSWDateTimeConverter converter)
    {
        if(converter==null)
        {
            dateTimeConverter = new DSWStandardDateTimeConverter();
        }
        dateTimeConverter=converter;
    }

    public static DSWDateTimeConverter getDateTimeConverter()
    {
        return dateTimeConverter;
    }

    private static DSWDateTimeConverter dateTimeConverter = new DSWStandardDateTimeConverter();

    public DSWExtendedSoapSerializationEnvelope() {
        this(SoapEnvelope.VER11);
    }

    public DSWExtendedSoapSerializationEnvelope(int soapVersion) {
        super(soapVersion);
        implicitTypes = true;
        setAddAdornments(false);
        new DSWMarshalGuid().register(this);
    ...
    protected void writeProperty(XmlSerializer writer, java.lang.Object obj, PropertyInfo type) throws IOException {
        ...
        if (!type.multiRef && qName[2] == null )
        {
            if (!implicitTypes || (obj.getClass() != type.type && !(obj instanceof Vector ) && type.type!=java.lang.String.class  )) {
                java.lang.String xmlName=DSWHelper.getKeyByValue(classNames,obj.getClass());
                if(xmlName!=null) {
    ...
    private Object createObject(Object soap, Class cl) throws InstantiationException, IllegalAccessException, NoSuchMethodException, InvocationTargetException {
        ...
        Method ctor = obj.getClass().getMethod("loadFromSoap",Object.class,DSWExtendedSoapSerializationEnvelope.class);
    ...
    public static java.lang.Object getXSDType(java.lang.Object param)
    {
        ...
        java.lang.String xmlName=DSWHelper.getKeyByValue(classNames,obj);
        if(xmlName==null)
        {
            return obj;
        }
