package com.onurerkantoros.hrms.Cores.ForeignServices.MernisService.Mernis;
...
public class DSWKPSPublicSoap12
{
    interface DSWIWcfMethod
    {
        DSWExtendedSoapSerializationEnvelope CreateSoapEnvelope() throws java.lang.Exception;

        java.lang.Object ProcessResult(DSWExtendedSoapSerializationEnvelope __envelope,java.lang.Object result) throws java.lang.Exception;
    }
    ...
    public DSWKPSPublicSoap12(){}

    public DSWKPSPublicSoap12(String url)
    {
        this.url = url;
    }

    public DSWKPSPublicSoap12(String url,int timeOut)
    {
        this.url = url;
    ...
    protected DSWExtendedSoapSerializationEnvelope createEnvelope()
    {
        DSWExtendedSoapSerializationEnvelope envelope= new DSWExtendedSoapSerializationEnvelope(DSWExtendedSoapSerializationEnvelope.VER12);
        envelope.enableLogging = enableLogging;
    
        return envelope;
    }

    protected java.util.List sendRequest(String methodName,DSWExtendedSoapSerializationEnvelope envelope,org.ksoap2.transport.Transport transport ,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile )throws java.lang.Exception
    {
    ...
    java.lang.Object getResult(java.lang.Class destObj,java.lang.Object source,String resultName,DSWExtendedSoapSerializationEnvelope __envelope) throws java.lang.Exception
    {
        if(source==null)
        {
            return null;
    ...
    public Boolean TCKimlikNoDogrula(final Long TCKimlikNo,final String Ad,final String Soyad,final Integer DogumYili) throws java.lang.Exception
    {
        ...
        return (Boolean)execute(new DSWIWcfMethod()
        {
            @Override
            public DSWExtendedSoapSerializationEnvelope CreateSoapEnvelope(){
                DSWExtendedSoapSerializationEnvelope __envelope = createEnvelope();
            ...
            @Override
            public java.lang.Object ProcessResult(DSWExtendedSoapSerializationEnvelope __envelope,java.lang.Object __result)throws java.lang.Exception {
    ...
    protected java.lang.Object execute(DSWIWcfMethod wcfMethod,String methodName,com.easywsdl.exksoap2.ws_specifications.profile.WS_Profile profile) throws java.lang.Exception
    {
        org.ksoap2.transport.Transport __httpTransport=createTransport();
        __httpTransport.debug=enableLogging;
        DSWExtendedSoapSerializationEnvelope __envelope=wcfMethod.CreateSoapEnvelope();
        try
        {
    ...
    protected java.lang.Exception convertToException(org.ksoap2.SoapFault fault,DSWExtendedSoapSerializationEnvelope envelope)
    {
