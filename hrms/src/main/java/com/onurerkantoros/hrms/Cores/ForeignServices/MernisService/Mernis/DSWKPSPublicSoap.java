...
public class DSWKPSPublicSoap
{
    ...
    public DSWKPSPublicSoap(){}

    public DSWKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public DSWKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        DSWExtendedSoapSerializationEnvelope envelope= new DSWExtendedSoapSerializationEnvelope(DSWExtendedSoapSerializationEnvelope.VER11);
