...
public class QVLKPSPublicSoap
{
    ...
    public QVLKPSPublicSoap(){}

    public QVLKPSPublicSoap(String url)
    {
        this.url = url;
    }

    public QVLKPSPublicSoap(String url,int timeOut)
    {
        this.url = url;
    ...
    {
        QVLExtendedSoapSerializationEnvelope envelope= new QVLExtendedSoapSerializationEnvelope(QVLExtendedSoapSerializationEnvelope.VER11);
